import type { TenderUiConfig } from "./types";

export const ADMIN_CONFIG_STORAGE_KEY = "epd_tender_admin_config_v1";

export const DEFAULT_TENDER_CONFIG: TenderUiConfig = {
  schema_version: "1.0.0",
  updated_at: "2026-02-13T00:00:00Z",
  default_template_id: "nec-default-v1",
  standards_catalog: [
    {
